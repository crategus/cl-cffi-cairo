...
;; TODO: G-MALLOC is in GLib

#+nil
(test image-surface-create-for-data
  (let* ((height 150)
         (width 200)
...
(test image-surface-get
  (let* ((height 150)
         ...
         (surface (cairo:image-surface-create-for-data data
                                                       :argb32
                                                       width height stride)))
    (is (cffi:pointer-eq data (cairo:image-surface-data surface)))
